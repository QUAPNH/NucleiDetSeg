...
class MaskScoringRoIHead(StandardRoIHead):
    ...
    def _mask_forward_train(self, x, sampling_results, bbox_feats, gt_masks,
        ...
        # print("mask_pred")
        # print(mask_results['mask_pred'].shape)
        #
        # print(range(mask_results['mask_pred'].size(0)))

        pos_mask_pred = mask_results['mask_pred'][
            range(mask_results['mask_pred'].size(0)), pos_labels]

        # print("pos_mask_pred")
        # print(pos_mask_pred.shape)
        ...
        # print("pos_mask_iou_pred")
        # print(pos_mask_iou_pred.shape)
        # print("mask_iou_targets")
        # print(mask_iou_targets.shape)
