...
basic_arch_root = [
    'Cascade_Mask-Rcnn', 'double_heads', 'fcos', 'foveabox', 'free_anchor',
    'grid_rcnn', 'GA-RPN', 'HTC', 'libra_rcnn', 'atss', 'Mask_Rcnn',
...
benchmark_pool = [
    ...
    'configs/GA-RPN/ga_faster_r50_caffe_fpn_1x_coco.py',
    ...
    'configs/Cascade_Mask-Rcnn/cascade_mask_rcnn_r50_fpn_1x_coco.py',
